...
if __name__ == "__main__":
    ...
    snapshot_path = "/data/home/tiany/Projects/project_TransUNet/model/{}/{}".format(args.exp, 'TU')
    ...
    log_folder = './results_iclr_rebuttal/test_log_' + args.exp + '_' + str(args.vit_name)+ '_epoch' + str(args.max_epochs)
