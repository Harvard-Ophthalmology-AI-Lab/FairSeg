...
from utils import DiceLoss, febs_loss
...
def trainer_fairseg(args, model, snapshot_path):
    ...
    dice_loss = febs_loss(num_classes, n_attr=sens_classes, gamma=args.gamma)
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            loss_dice = dice_loss(outputs, label_batch, attrs, softmax=True)
