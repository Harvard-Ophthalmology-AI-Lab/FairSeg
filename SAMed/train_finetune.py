...
from trainer_novel import trainer_fairseg
...
parser.add_argument('--center_crop_size', type=int,
                    default=420, help='center croped image size | 512 for slo, 420 for oct fundus')
...
parser.add_argument('--lora_ckpt', type=str, default='', help='Finetuned lora checkpoint')
